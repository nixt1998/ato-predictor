...
export default function QuickFilters({ filters, onChange }: QuickFiltersProps) {
  ...
  const quickFilters: Array<{
    ...
    { key: 'high', emoji: '🔴', color: 'bg-red-100 text-red-600', hoverColor: 'hover:bg-red-200' },
    { key: 'medium', emoji: '🟡', color: 'bg-yellow-100 text-yellow-600', hoverColor: 'hover:bg-yellow-200' },
    { key: 'low', emoji: '🟢', color: 'bg-green-100 text-green-600', hoverColor: 'hover:bg-green-200' },
    { key: 'pinned', emoji: '📌', color: 'bg-blue-100 text-[#005EB8]', hoverColor: 'hover:bg-blue-200' },
    { key: 'today', emoji: '📅', color: 'bg-purple-100 text-purple-600', hoverColor: 'hover:bg-purple-200' },
    { key: 'thisWeek', emoji: '🗓️', color: 'bg-indigo-100 text-indigo-600', hoverColor: 'hover:bg-indigo-200' },
  ]
  ...
  return (
    <div className="flex flex-wrap gap-2">
      {quickFilters.map(({ key, emoji, color, hoverColor }) => {
